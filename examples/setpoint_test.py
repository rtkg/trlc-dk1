...
Usage:
    python examples/setpoint_test.py --port /dev/ttyACM1 --joint joint_3
...
def main():
    ...
    parser.add_argument("--arm_kp", type=float, nargs=6, default=None,
                        help="MIT Kp gains for joints 1-6 (default: 80 70 60 20 20 10)")
    parser.add_argument("--arm_kd", type=float, nargs=6, default=None,
                        help="MIT Kd gains for joints 1-6 (default: 5 5 4 1 1 1)")
    ...
    if args.display_data:
        init_rerun(session_name="setpoint_test", ip=args.display_url, port=args.display_port)
    ...
    try:
        while True:
            ...
            # Pause for 3s at each zero crossing (skip the initial t≈0)
